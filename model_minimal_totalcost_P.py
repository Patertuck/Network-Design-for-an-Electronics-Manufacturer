...
print()
print(f"Given the CO2 price of {CO2PRICE}$ per tonne, the minimal total cost: {current_optimum}$")
print(f"Added up: {transport_cost + slowness_cost + handling_cost + sourcing_cost + CO2_emission_cost}")        
